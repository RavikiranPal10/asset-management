<?php
// complain.php — Customer Complaint (Bookman Old Style) with unified header/footer
session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<title>Complain | Property / Asset Management System</title>
...
<div class="wrap">
  ...
  <header class="hero">
    <h1>Complain</h1>
    <p>Had a bad experience with us? Register a complaint here.</p>
  </header>
...
<?php require __DIR__ . '/nav.php'; ?>
  ...
  <!-- Title -->
  <div class="page-title"><h2>Complaint Management</h2></div>

  <!-- Content -->
  <section class="grid">
    <div class="photo">
      <img src="/asset-management/complain-image.jpg" alt="Customer Complaint">
    </div>
    ...
    <div class="card">
      ...
      <?php
        // flash messages (optional; will show if set by complain-submit.php later)
      ...
      <!-- Ready for DB: point to complain-submit.php -->
      <form method="post" action="complain-submit.php" autocomplete="off">
        <div class="row">
          <div>
        ...
        <div class="row">
          <div>
            ...
            <select id="category" name="category" required>
              ...
              <option>Document / Agreement</option>
        ...
        <textarea id="details" name="details" minlength="20" placeholder="Please describe your issue…" required></textarea>
        ...
        <div class="note">You’ll receive an acknowledgement on your email once we register your complaint.</div>
      </form>
    </div>
  </section>
